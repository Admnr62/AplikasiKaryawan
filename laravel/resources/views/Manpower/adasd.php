                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="nama" name="nama"
                                        value="{{ $manpower->nama }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="badge_number" class="form-control-label">Badge Number</label>
                                    <input class="form-control" type="text" id="badge_number" name="badge_number"
                                        value="{{ $manpower->badge_number }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="no_register" name="no_register"
                                        value="{{ $manpower->no_register }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="customer" name="customer"
                                        value="{{ $manpower->customer }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="tipe_permit" name="tipe_permit" required>
                                        ...
                                        <option value="ID ONLY > WARNA PUTIH" {{ $manpower->tipe_permit == 'ID ONLY >
                                            WARNA PUTIH' ? 'selected' : '' }}>ID ONLY > WARNA PUTIH</option>
                                        <option value="PIT WORKER PERMIT > WARNA PINK" {{ $manpower->tipe_permit == 'PIT
                                            WORKER PERMIT > WARNA PINK' ? 'selected' : '' }}>PIT WORKER PERMIT > WARNA
                                            PINK</option>
                                        <option value="IN PIT ACCESS ONLY > WARNA BIRU" {{ $manpower->tipe_permit == 'IN
                                            PIT ACCESS ONLY > WARNA BIRU' ? 'selected' : '' }}>IN PIT ACCESS ONLY >
                                            WARNA BIRU</option>
                                        <option value="FULL PIT ACCESS ONLY > WARNA KUNING" {{ $manpower->tipe_permit ==
                                            'FULL PIT ACCESS ONLY > WARNA KUNING' ? 'selected' : '' }}>FULL PIT ACCESS
                                            ONLY > WARNA KUNING</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" id="permit_status" name="permit_status"
                                        value="{{ $manpower->permit_status }}" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="date" id="masa_berlaku_permit"
                                        name="masa_berlaku_permit" value="{{ $manpower->masa_berlaku_permit }}"
                                        required>
                                </div>
                            </div>
                             <div class="form-group">
